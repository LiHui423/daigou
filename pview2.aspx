<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pview2.aspx.cs" Inherits="pview2" %>
...
<%
    ...
    System.Data.DataTable ShopInfo = LS_J_SQL.GetDataTable("select shopname,ZTState,recycle from [shop] where id=" + dr["shopid"].ToString() + "");
    //若商品所属商店关闭则跳转
    ...
    //取得代购相关汇率计算
    System.Data.DataTable SetTable = LS_J_SQL.GetDataTable("select percentage,KGmutliple from SetTable where id=" + dr["ExchangeId"] + "");
...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/global_common.css" />
		<link rel="stylesheet" type="text/css" href="css/global_detail.css" />
	...
	<body class="scrollBar_0">
		...
		<div class="container scrollBar_0">
			...
			<!--第一部分-->
				...
				<div class="shop_detail">
					...
					<div class="shop_box">
						...
						<div class="detail_price">
							...
							<span class="npr11">
                            <h3>原價</h3>
                            <del><%=dr["CostPrice"]%></del>
                            </span>
                            <div class="detail_courier">
                                <span class="courier">運費 :</span>
                                <sapn class="courPrice">MOP 0</span>&nbsp/&nbsp
                                <span class="rmbPrice">暫無數據 0</span>
						    </div>
						</div>
					</div>
				...
				<div class="detail_otherBuy">
					...
					<div class="otherBuy_text">其他淘寶代購 ：</div>
				</div>
		...
		<!--底部我要~買-->
		<div class="Bottom_wantBuy">
            <a href="yeeper_col.aspx?shopid=<%=dr["shopid"] %>" class="shopBG">
                <div class="wantBuy_check"></div>
                進店看看
            </a>
		...
		<div id="iwtts">
            ...
            <div class="iwbox">
                ...
                <dl class="iwbh">
                    <dt class="iwbdt1"><span id="preMoneyShow">MOP</span><span id="MoneyShow"><%=FinallyPrice %></span></dt>
                </dl>
                <dl class="iwbd">
            ...
            $(function () {
                ...
                if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                    ...
                    $pannd.on(touchEvent, function (e) {
                        ...
                        e.preventDefault;
                        $tmodal.css({visibility: 'visible', display: 'block',opacity: '1' })
                        var tex = $(this).find('.pitem').html()
                        $popcon.html(tex)
                        $pobg.show();
                        $(this).addClass('cur');
...
$(function(){
	...
	function bigGlass(arr,idx){
		...
		$.each(arr,function(k,y){
            ...
            var context=ChooseArray[k].split('|');
            $.each(context,function(k1,y1){
                if(y1 !== ""){
                    newArray.push(y1);
                }
			...
			var itemArr = [
				'<div class="swiper-slide">',
					'<div class="swiper-zoom-container">',
						'<img src="'+y+'">',
						'<span class="picShopDetail">'+newArray.join(',')+'</span>',
					'</div>',
				'</div>'
			];
			item+=itemArr.join('');
            ...
            <div class="list_item" id="<$=list[i].Aid$>">
                ...
                <div class="item_info">
                    ...
                    <div class="item_price">
                        ...
                        <span class="easyColor"><$=formatNum(list[i].Price)$></span>                   
                    </div>
                    <p><$=list[i].shopname$><$=list[i].currency$><$=formatNum(countPrice(list[i].Price,list[i].exchange))$></p>
                    <!-- change -->
                    <div class="item_user">
                        <span><span><$=list[i].name$></span>發起代購</span>
                        <!-- 原本这里是心动的，后来去掉了 -->
                        <!-- <span>123</span>
